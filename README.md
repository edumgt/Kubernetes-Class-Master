...
- 실습 강의 폴더: `lecture01` ~ `lecture11`
- 주제 폴더(이론/심화): `topic01_setup` ~ `topic07_reference`
- 각 lecture 폴더에 `README.md`로 목표/순서/연계 문서 정리
...
- **실습 강의(lecture01~11)**: practice 단위 실습 중심 구조
- **주제 문서(topic01~07)**: 통합 이론/심화/운영 문서

## 이미지 자료

실습 스크린샷은 주제 문서(`topicXX`)와 함께 관리됩니다.

## 활용 방법

1. `lecture01`부터 `lecture11`까지 순서대로 실습합니다.
2. 각 lecture의 `README.md`에서 실습 목표와 진행 순서를 확인합니다.
3. 필요한 이론은 `topic01~07` 문서를 병행 참고합니다.
