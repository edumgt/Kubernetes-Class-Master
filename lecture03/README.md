# Lecture 03 - Pods with kubectl

> 이 README는 lecture03 폴더의 개별 MD를 통합한 강의 노트입니다.

## 강의 목표
- `kubectl` 기반 Pod 생성/조회/삭제/디버깅 숙련
- Node-Pod 관측 흐름 이해
...
## 권장 순서
1. 이론 문서로 Node/Pod 관측 흐름 파악
2. `02-PODs-with-kubectl` 실습
3. `lecture04`로 이동
